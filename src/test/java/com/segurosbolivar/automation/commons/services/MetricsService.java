...
public class MetricsService {
    ...
    public static Integer createCase(String casename,String casedescription, String casejiraID) throws JsonProcessingException {
    	ObjectMapper mapper = new ObjectMapper();
    	Map<String, Object> data = new HashMap<>();
    	data.put("name",casename);
        data.put("description",casedescription);
        data.put("idJiraIssue",casejiraID);
        data.put("inProductionDate","2021-07-06");
        data.put("manualRunTime","00:05:00");
        data.put("idPlatform",ServiceConstants.PLATFORM_ID);
        data.put("idProject",ServiceConstants.PROJECT_ID);
